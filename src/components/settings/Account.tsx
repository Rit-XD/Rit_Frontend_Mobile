        ...
        <ThemedView style={styles.container}>
            ...
            <View>
                <Pressable onPress={pickImage} style={styles.profilepic}>
                    ...
                    {!image && <Image source={"https://iqfcxjbnqcpjzggtcptb.supabase.co/storage/v1/object/public/profilePics/placeholder.jpg"} style={styles.image}/>}
                ...
                <View style={styles.address}>
                    <View>
                        ...
                        <Input value={user.city} onChangeText={()=>{}} style={{width: 234}}/>
                    </View>
                    <View>
                        <ThemedText style={styles.label}>Postcode</ThemedText>
                        <Input value={user.postal} onChangeText={()=>{}} style={{width: 95}}/>
                    </View>
                </View>
            </View>
            <Button>
